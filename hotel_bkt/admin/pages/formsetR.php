...
<section class="panel">
      ...
      <a class="btn btn-success btn-sm" title="tambah" onclick="addroom()"><i class="fa fa-plus"></i></a>
          <a class="btn btn-success btn-sm" title="cancel" onclick="rem()"><i class="fa fa-times"></i></a>
