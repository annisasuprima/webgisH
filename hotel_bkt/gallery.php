      ...
      <header class="header black-bg" style="background-color:black;border-bottom:1px solid black;">
        <div class="sidebar-toggle-box">
          <div class="fa fa-bars tooltips" data-placement="right" data-original-title="Toggle Navigation" style="color:white"></div>
            ...
            <!--logo start-->
        <a href="index.php" class="logo" style="color:white"><b>WebGis Hotel (12 1811521015 Annisa Suprima)</b></a>
        <div class="top-menu">
                      ...
                      <section class="panel">
                          <div class="panel-body">
                             ...
                             <div style="overflow-y: auto; overflow-x:auto; margin:15px; display:flex; justify-content:center">
                              <div class="html5gallery" style="max-height:700px; overflow:auto; display:block;" data-skin="horizontal" data-width="400" data-height="250" data-resizemode="fit"><?php
